...
# --- All the core functions are the same ---
...
def run_simulation(tank_mask, mixed_signal, input_filters, sensor_coords, drive_strength):
    ...
    for t in range(n_steps):
        ...
        u_new = u - DT * (u * du_dx + g * dh_dx + b * u); v_new = v - DT * (v * dv_dy + g * dh_dy + b * v)
...
if __name__ == "__main__":
    print("--- Drive Strength Diagnostic Tool ---")
    ...
    for strength in drive_strengths_to_test:
        ...
        # Run the simulation with the current strength
    ...
    print("\n--- Recommendation ---")
    if best_mse >= 0.99:
         print("All tested strengths resulted in a poor MSE (>= 0.99).")
         print("The system is likely too stable or the signal is too weak.")
         print("Try increasing the drive strength values in the test list.")
    else:
        print(f"The best performing value is DRIVE_STRENGTH = {best_strength}.")
        print("Update this value in the main GA script to proceed.")